...
Send_Temperature:
    ...
    ; Update the first decimal place
    mov a, bcd+2            ; Load the next digit
	Send_BCD(a)
	
	mov a, #'.'
    lcall putchar
	
    ; Update the second decimal place
    mov a, bcd+1            ; Load the second last digit
	Send_BCD(a)
    
    mov a, bcd+0            ; Load the last digit
	Send_BCD(a)          ; Store in string buffer
...
; Send a constant null-terminated string using the serial port
