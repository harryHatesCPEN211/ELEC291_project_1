...
config_Mode: dbit 1; 1 = Config, 0 = Normal
Select_Param: dbit 1 ; 0 = Soak Temp, 1 = Soak Time, 2 = Reflow Temp, 3 = Reflow Time
...
LCD_PB_Done:
	jb Config_Mode, Modify_Parameter		
	ret

Modify_Parameter:
	;Toggle Selected Parameter(PB0)

	jnb PB0, Toggle_Selected_Param

	jnb PB1, Increment_Selected_Param

	jnb PB2, Decrement_Selected_Param

	jnb PB3, Exit_Config_Param
...
FSM_CheckState0:
    ...
    cjne A, #0, FSM_CheckState1
        ...
        lcall LCD_PB
        jnb PB3, FSM_Enter_Config_Mode
		sjmp FSM_Exit_Config_Mode_Check

FSM_Enter_Config_Mode:
	setb config_Mode
	mov Select_Param, #0
	ret

FSM_Exit_Config_Mode_Check:
	jnb config_Mode, FSM_Exit_Config_Mode_Check
	ret
FSM_Exit_Config_Mode:
	clr Config_Mode
	ret
